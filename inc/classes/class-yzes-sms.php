...
class YZES_SMS {
	...
	public function __construct( $sms_user, $sms_pass, $sms_from, $sms_to, $sms_msg ) {
	...
	public function send() {
		...
		return file_put_contents("http://payamak.ir/index2.php?goto=webservice/json&method=send&arg1={$this->sms_user}&arg2={$this->sms_pass}&arg3={$this->sms_to}&arg4={$this->sms_from}&arg5={$this->sms_msg}");
